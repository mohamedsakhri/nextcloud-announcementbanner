        ...
        return new TemplateResponse(
            ...
            [
                ...
                'labels' => [
                    ...
                    'apps' => $this->l10n->t('Apps'),
                    'allApps' => $this->l10n->t('All apps'),
                    'appTargets' => $this->l10n->t('Apps'),
                    'appTargetsHelp' => $this->l10n->t('Select the apps that should show this banner. Leave empty to show it on all apps.'),
                    'appTargetsPlaceholder' => $this->l10n->t('Specific apps'),
